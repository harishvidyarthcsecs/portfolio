        ...
        <div className="footer-inner">
            <div className="footer-top">
                ...
                <div className="footer-column">
                    <span className="footer-badge">open to opportunities?</span>
                    <h3>yes, absolutely :)</h3>
                </div>
                {/* Location */}
                <div className="footer-column">
                    ...
                    <a href="https://maps.app.goo.gl/REC" target="_blank" rel="noopener noreferrer" className="footer-map-link">
                ...
                <div className="footer-column">
                    ...
                    <a href="mailto:harishvidyarth@gmail.com" className="footer-email">harishvidyarth@gmail.com</a>
                    <a href="tel:+916382551983" className="footer-whatsapp">+91 – 6382551983</a>
                    <p className="footer-note">reach out anytime — always happy to connect.</p>
            ...
            <div className="footer-bottom">
                <div className="footer-big-text">
                    <p className="footer-logo__svg" style={{ fontFamily: 'var(--font-epilogue, sans-serif)', fontWeight: 800, fontSize: 'clamp(3.5rem, 10vw, 9rem)', lineHeight: 1, margin: 0, color: 'currentColor', letterSpacing: '-0.02em' }}>
                        Harish<br />Vidyarth
                    </p>
                </div>
                    ...
                    <div className="footer-credits-wrapper">
                        <div className="credits-box">
                            <div className="credits-content">
                                    ...
                                    <div className="overflow-wrapper"><span className="credits-label">designed &amp; built by</span></div>
                                    <div className="overflow-wrapper"><a href="https://linkedin.com/in/harishvidyarth" target="_blank" rel="noopener noreferrer" className="credits-name" data-wiggle-target="true">Harish Vidyarth</a></div>
                                </div>
                            </div>
                        </div>
                        <a href="#" className="footer-credits">built by harish</a>
                    </div>
                </div>
            </div>
        </div>
