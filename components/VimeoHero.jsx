            ...
            >
                ...
                <div className="home-header__title">
                    <h1 className="vimeo-hero__title" ref={titleRef} onClick={(e) => e.stopPropagation()}>
                        ...
                        {/* "building" */}
                        <span className="vimeo-hero__word">building </span>

                        {/* "secure" + ⑤ smiley (no animation) */}
                        ...
                        {/* "systems" italic */}
                        <span className="vimeo-hero__word"><em>systems </em></span>
                        ...
                        <span className="vimeo-hero__word">research </span>
                        <span className="vimeo-hero__word">& </span>

                        {/* "code." + ⑤ pink star (no spin) + oval underline */}
                        <span className="vimeo-hero__word is--relative">
