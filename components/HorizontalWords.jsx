...
const HorizontalWords = () => {
    ...
    useEffect(() => {
        const ctx = gsap.context(() => {
            ...
            // Mobile: fade in arrow SVG only after text has scrolled into view
            if (window.innerWidth <= 768) {
                const arrowSvg = container.querySelector('.horizontal-words__arrow-svg');
                if (arrowSvg) {
                    gsap.set(arrowSvg, { opacity: 0 });
                    ScrollTrigger.create({
                        animation: gsap.fromTo(arrowSvg, { opacity: 0 }, { opacity: 1 }),
                        trigger: container.querySelector('.horizontal-words__h2'),
                        containerAnimation: scrollTween,
                        start: 'left 85%',
                        end: 'left 55%',
                        scrub: 0.5,
        ...
        <section ref={sectionRef} className="horizontal-words-section content-section">
            <div className="horizontal-words__relative">
                <div className="horizontal-words__sticker-svg">
                    ...
                    <h2 className="display horizontal-words__h2" aria-label="solving what others call impossible.">
            ...
            <div className="horizontal-words__bottom-text">
                <div className="horizontal-words__bottom-text-l">
                    I build <em>and</em> analyse secure systems through hands-on<br />
                    cybersecurity projects, mathematical research, and<br />
                    real-world engineering — from networks to karate.
                </div>
            </div>
        </section>
    );
