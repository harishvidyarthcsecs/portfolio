// ─── lib/data.js — Static data for Harish Vidyarth's portfolio ───────────────
// ES Module exports — imported by React components

// Marquee tech stack / tools
export const brands = [
    { name: "Python", src: "/assets/Brand Logos SVG/tech_python.svg" },
    { name: "C", src: "/assets/Brand Logos SVG/tech_c.svg" },
    { name: "JavaScript", src: "/assets/Brand Logos SVG/tech_javascript.svg" },
    { name: "LaTeX", src: "/assets/Brand Logos SVG/tech_mongodb.svg" },
    { name: "HTML", src: "/assets/Brand Logos SVG/tech_github.svg" },
    { name: "Graph Theory", src: "/assets/Brand Logos SVG/tech_graphtheory.svg" },
    { name: "Cybersecurity", src: "/assets/Brand Logos SVG/tech_cybersec.svg" },
    { name: "Linux", src: "/assets/Brand Logos SVG/tech_tux.svg" },
    { name: "GitHub", src: "/assets/Brand Logos SVG/tech_octocat.svg" },
    { name: "Canva", src: "/assets/Brand Logos SVG/tech_canva.svg" }
];
...
export const SOCIAL_ICONS = [
    {
        href: 'https://linkedin.com/in/harishvidyarth',
        label: 'LinkedIn',
    ...
    {
        href: 'https://github.com/harishvidyarthcsecs',
        label: 'GitHub',
        svg: '<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 40 40" fill="none" data-wiggle-target="" aria-hidden="true"><path fillRule="evenodd" clipRule="evenodd" d="M20 4C11.163 4 4 11.163 4 20C4 27.163 8.763 33.21 15.35 35.35C16.15 35.5 16.437 35.013 16.437 34.588C16.437 34.2 16.413 32.938 16.413 31.6C12 32.338 10.96 30.588 10.64 29.675C10.462 29.213 9.68 27.76 9 27.375C8.44 27.063 7.64 26.325 8.977 26.3C10.24 26.275 11.137 27.475 11.44 27.963C12.88 30.375 15.188 29.7 16.5 29.275C16.64 28.238 17.063 27.538 17.525 27.138C13.563 26.713 9.44 25.2 9.44 18.6C9.44 16.763 10.063 15.238 11.488 14.063C11.275 13.5 10.713 11.75 11.7 9.425C11.7 9.425 13.037 8.925 16.437 11.1C18.163 10.6 19.988 10.35 21.8 10.35C23.612 10.35 25.438 10.6 27.163 11.1C30.563 8.9 31.9 9.425 31.9 9.425C32.887 11.75 32.325 13.5 32.112 14.063C33.538 15.238 34.16 16.738 34.16 18.6C34.16 25.225 30.012 26.713 26.05 27.138C26.65 27.663 27.163 28.675 27.163 30.238C27.163 32.463 27.138 34.25 27.138 34.588C27.138 35.013 27.425 35.525 28.225 35.35C31.514 34.268 34.363 32.134 36.369 29.265C38.375 26.395 39.444 22.941 39.44 19.4C39.44 11.163 32.163 4 20 4Z" fill="currentColor"/></svg>'
    }
];

// Portfolio section cards data
export const CARDS_DATA = [
    {
        color: 'green',
        sticker: 'camera',
        title: 'cybersecurity',
        services: ['Vulnerability Analysis', 'Network Hardening', 'Secure System Design', 'Cryptography', 'Digital Forensics', 'Reverse Engineering', 'CTF Competitions']
    },
    {
        color: 'darkblue',
        sticker: 'phone',
        title: 'research',
        services: ['Graph Theory', 'Network Analysis', 'Parallel & Distributed Computing', 'SCI Q1 Publication', 'Conference Presentations', 'Biswapped Networks', 'Wiener Index']
    },
    {
        color: 'orange',
        sticker: 'smiley',
        title: 'development',
        services: ['Python Full Stack', 'Django / Flask', 'MongoDB & NoSQL', 'HTML / CSS / JS', 'Web Deployment', 'SEO & Hosting', 'GitHub']
    },
    {
        color: 'maroon',
        sticker: 'hand',
        title: 'achievements',
        services: ['SIH 2025 National Runner-Up', 'CTF Competition Top-25', 'Bebras National Rank #4', '2nd Dan Black Belt', 'WKF Judge B License', 'SCI Q1 Publication']
    },
    {
        color: 'pink',
        sticker: 'heart',
        title: 'music & more',
        services: ['Keyboard Player', 'Active Musician', 'proeliumacademy.in', 'ISRO Campus Visit', 'IIT Alumni Lecture Series']
    }
];
